...
export const quizCreateSchema = Joi.object({
  ...
  questions: Joi.array().items(
    Joi.object({
      ...
      correctAnswer: Joi.alternatives().try(Joi.string().allow(''), Joi.number(), Joi.boolean(), Joi.array().items(Joi.string().allow(''), Joi.number(), Joi.boolean())).optional(),
...
export const quizAttemptSchema = Joi.object({
  answers: Joi.array().items(
    Joi.object({
      ...
      answer: Joi.alternatives().try(Joi.string().allow(''), Joi.number(), Joi.boolean(), Joi.array().items(Joi.string().allow(''), Joi.number(), Joi.boolean())).optional(),
    })
  ).required(),
});
