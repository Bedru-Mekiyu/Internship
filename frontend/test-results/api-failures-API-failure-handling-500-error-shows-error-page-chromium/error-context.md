...
- Name: api-failures.spec.ts >> API failure handling >> 500 error shows error page
- Location: e2e/api-failures.spec.ts:15:3
...
Locator: getByText(/error|unavailable|temporary/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/error|unavailable|temporary/i)
