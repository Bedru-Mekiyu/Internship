...
- Name: real-auth.spec.ts >> authentication security >> redirect preserves intended destination
- Location: e2e/real-auth.spec.ts:91:3
...
Received string:  "http://127.0.0.1:4173/auth/login"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://127.0.0.1:4173/auth/login"
