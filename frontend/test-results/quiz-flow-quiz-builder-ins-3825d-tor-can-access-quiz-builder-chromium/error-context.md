...
- Name: quiz-flow.spec.ts >> quiz builder (instructor) >> instructor can access quiz builder
- Location: e2e/quiz-flow.spec.ts:61:3
...
Locator: getByRole('heading', { name: /quiz builder|create quiz/i }).or(getByText('Quiz Builder'))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /quiz builder|create quiz/i }).or(getByText('Quiz Builder'))
