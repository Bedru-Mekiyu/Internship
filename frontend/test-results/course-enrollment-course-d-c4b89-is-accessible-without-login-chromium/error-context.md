...
- Name: course-enrollment.spec.ts >> course discovery for unauthenticated users >> explore courses page is accessible without login
- Location: e2e/course-enrollment.spec.ts:96:3
