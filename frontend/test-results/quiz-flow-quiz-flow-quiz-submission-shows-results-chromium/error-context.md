...
- Name: quiz-flow.spec.ts >> quiz flow >> quiz submission shows results
- Location: e2e/quiz-flow.spec.ts:39:3
...
Locator: getByRole('heading', { name: /results|score|quiz complete/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /results|score|quiz complete/i })
  ...
  - main [ref=e20]:
    - generic [ref=e25]:
      ...
      - generic [ref=e28]:
        ...
        - paragraph [ref=e30]: The page "/quiz-results" doesn't exist or has been moved.
      - generic [ref=e31]:
