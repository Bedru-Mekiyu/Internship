...
- Name: security-authorization.spec.ts >> API security boundaries >> API returns proper error for expired token
- Location: e2e/security-authorization.spec.ts:214:3
...
Locator: getByText(/session expired|please sign in/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/session expired|please sign in/i)
...
- generic [ref=e6]:
  ...
  - generic [ref=e32]:
    - button "GH GitHub" [ref=e33] [cursor=pointer]:
      - generic [ref=e34]: GH
      - text: GitHub
    - button "G Google" [ref=e35] [cursor=pointer]:
      - generic [ref=e36]: G
      - text: Google
  - paragraph [ref=e37]:
