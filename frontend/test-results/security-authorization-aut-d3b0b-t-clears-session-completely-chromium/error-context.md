...
- Name: security-authorization.spec.ts >> authentication security >> logout clears session completely
- Location: e2e/security-authorization.spec.ts:69:3
...
Call log:
  - waiting for locator('[class*="logout"], button:has-text("Logout"), [aria-label="Logout"]')
