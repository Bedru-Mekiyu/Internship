...
- Name: quiz-flow.spec.ts >> quiz builder (instructor) >> instructor can save quiz
- Location: e2e/quiz-flow.spec.ts:92:3
...
Locator: getByRole('button', { name: /save quiz|publish/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /save quiz|publish/i })
