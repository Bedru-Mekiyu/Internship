...
- Name: security-authorization.spec.ts >> authorization boundaries >> instructor cannot access user management
- Location: e2e/security-authorization.spec.ts:112:3
...
Expected pattern: /\/instructor|403/
Received string:  "http://127.0.0.1:4173/admin/users"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://127.0.0.1:4173/admin/users"
