...
- Name: quiz-flow.spec.ts >> quiz builder (instructor) >> instructor can create new question
- Location: e2e/quiz-flow.spec.ts:70:3
...
Locator: getByRole('button', { name: /add question|new question/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /add question|new question/i })
