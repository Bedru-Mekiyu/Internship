...
- Name: course-enrollment.spec.ts >> course enrollment flow >> course filter by category works
- Location: e2e/course-enrollment.spec.ts:50:3
...
Locator: getByRole('combobox', { name: /category/i })
Expected: visible
Timeout: 10000ms
