...
- Name: quiz-flow.spec.ts >> quiz flow >> can view past quiz results
- Location: e2e/quiz-flow.spec.ts:46:3
...
Locator: getByRole('heading', { name: /my results|quiz history/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /my results|quiz history/i })
