...
- Name: course-enrollment.spec.ts >> course enrollment flow >> course filter by level works
- Location: e2e/course-enrollment.spec.ts:62:3
...
Locator: getByRole('combobox', { name: /level/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('combobox', { name: /level/i })
          ...
          - generic [ref=e124]:
            - generic [ref=e126]:
              ...
              - generic [ref=e134]:
                ...
                - link "React Foundations" [ref=e137] [cursor=pointer]:
                  - /url: /courses/course-react
                - generic [ref=e138]:
                  - generic [ref=e139]: I
