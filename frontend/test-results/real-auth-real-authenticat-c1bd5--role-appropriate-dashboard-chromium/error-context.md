...
- Name: real-auth.spec.ts >> real authentication flow >> login with valid credentials redirects to role-appropriate dashboard
- Location: e2e/real-auth.spec.ts:4:3
...
Locator: getByText('Student')
Expected: visible
Error: strict mode violation: getByText('Student') resolved to 3 elements:
    1) <p class="MuiTypography-root MuiTypography-body1 MuiTypography-noWrap css-9ty7ay">Student Tester</p> aka getByText('Student Tester')
    2) <p class="MuiTypography-root MuiTypography-body1 MuiTypography-noWrap css-11ujuki">student</p> aka getByText('student', { exact: true })
    3) <h4 class="MuiTypography-root MuiTypography-h4 css-19k6vgi">Welcome back, Student!</h4> aka getByRole('heading', { name: 'Welcome back, Student!' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Student')
