...
- Name: core-user-flows.spec.ts >> core user flows - admin dashboard >> admin can access user management
- Location: e2e/core-user-flows.spec.ts:155:3
...
Locator: getByText(/users|manage/i)
Expected: visible
Error: strict mode violation: getByText(/users|manage/i) resolved to 7 elements:
    ...
    2) <p class="MuiTypography-root MuiTypography-body1 MuiTypography-noWrap css-238799">Course Management</p> aka getByRole('link', { name: 'Course Management' })
    3) <p class="MuiTypography-root MuiTypography-body1 MuiTypography-noWrap css-ah3b2n">User Management</p> aka getByRole('link', { name: 'User Management' })
    4) <h4 class="MuiTypography-root MuiTypography-h4 css-19k6vgi">Users</h4> aka getByRole('heading', { name: 'Users' })
    5) <p class="MuiTypography-root MuiTypography-body1 css-1q07bx">Manage learner, instructor, and admin accounts wi…</p> aka getByText('Manage learner, instructor,')
    6) <p class="MuiTypography-root MuiTypography-body1 css-p21kgb">Loading users...</p> aka getByText('Loading users...')
    7) <p class="MuiTypography-root MuiTypography-body2 css-7wqyn8">…</p> aka getByText('Showing 0 to 0 of 0 users')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/users|manage/i)
...
- generic [ref=e3]:
  ...
  - main [ref=e122]:
    - generic [ref=e124]:
      - generic [ref=e125]:
        - generic [ref=e126]:
          - heading "Users" [level=4] [ref=e127]
          - paragraph [ref=e128]: Manage learner, instructor, and admin accounts with standardized role and status controls.
        - button "Add User" [ref=e129] [cursor=pointer]
      - generic [ref=e133]:
        - generic [ref=e136]:
          - img [ref=e138]
          - textbox "Search by name or email..." [ref=e140]
          - group
        - generic [ref=e142]:
          - generic [ref=e144]:
            - combobox [ref=e145] [cursor=pointer]: All Roles
            - textbox: All Roles
            - img
            - group
          - generic [ref=e147]:
            - combobox [ref=e148] [cursor=pointer]: All Status
            - textbox: All Status
            - img
            - group
      - generic [ref=e150]:
        - generic [ref=e151]:
          - heading "User Directory" [level=6] [ref=e152]
          - paragraph [ref=e153]: Role-based account list with quick actions.
        - table [ref=e155]:
          - rowgroup [ref=e156]:
            - row "User Role Status Last Login Joined Date Actions" [ref=e157]:
              - columnheader "User" [ref=e158]
              - columnheader "Role" [ref=e159]
              - columnheader "Status" [ref=e160]
              - columnheader "Last Login" [ref=e161]
              - columnheader "Joined Date" [ref=e162]
              - columnheader "Actions" [ref=e163]
          - rowgroup [ref=e164]:
            - row "Loading users..." [ref=e165]:
              - cell "Loading users..." [ref=e166]:
                - paragraph [ref=e167]: Loading users...
        - generic [ref=e168]:
          - paragraph [ref=e169]: Showing 0 to 0 of 0 users
          - navigation "pagination navigation" [ref=e170]:
            - list [ref=e171]:
              - listitem [ref=e172]:
