...
- Name: course-enrollment.spec.ts >> instructor course management >> instructor can access course creation
- Location: e2e/course-enrollment.spec.ts:119:3
...
Locator: getByRole('heading', { name: /create course/i }).or(getByText('New Course'))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /create course/i }).or(getByText('New Course'))
