...
- Name: core-user-flows.spec.ts >> core user flows - student dashboard >> student can browse course catalog
- Location: e2e/core-user-flows.spec.ts:78:3
...
Locator: getByPlaceholder(/search courses/i)
Expected: visible
Timeout: 5000ms
