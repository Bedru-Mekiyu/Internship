...
- Name: course-enrollment.spec.ts >> course enrollment flow >> view my courses shows enrolled courses
- Location: e2e/course-enrollment.spec.ts:85:3
...
Locator: getByRole('heading', { name: /my courses/i }).or(getByText('Enrolled Courses'))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /my courses/i }).or(getByText('Enrolled Courses'))
