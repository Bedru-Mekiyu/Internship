...
- Name: real-auth.spec.ts >> real authentication flow >> login with valid instructor credentials redirects to instructor dashboard
- Location: e2e/real-auth.spec.ts:17:3
